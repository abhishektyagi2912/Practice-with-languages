function nextbtn() {
    let football_jokes = document.getElementById("addTxt");
    let randNum = Math.ceil(Math.random() * 33);
    // console.log(jokes_arr[randNum]);

    football_jokes.innerHTML = jokes_arr[randNum];
}

let jokes_arr = ["Why don't grasshoppers watch football? They prefer cricket!",
